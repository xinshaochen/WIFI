...
void GetDataEvent(UartEvent e)
{
	...
	ConnectSendCode(sendIPstr,2333,1,s,6);
	e->noack();
...
//==============================================================================
	...
	{	
		...
		{
			ConnectSendCode(remoteDev[SeleRemoteDev].IP,2333,GetData,recvarraydata[i],2);
		}
	}
...
void getAdcVal()
{
	adCH1 = Get_Adc(ADC_CH1);
	adCH2 = Get_Adc(ADC_CH2);
}
