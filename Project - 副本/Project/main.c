...
//	LCD_ShowNum(145,100,reip[1],3,16);
//	LCD_ShowNum(209,100,reip[2],3,16);
//	LCD_ShowNum(273,100,reip[3],3,16);
	sprintf(p,"%d.%d.%d.%d",reip[0],reip[1],reip[2],reip[3]);
	ConnectSendCode(p,2333,0,&ip[3],1);
	retip=0;
